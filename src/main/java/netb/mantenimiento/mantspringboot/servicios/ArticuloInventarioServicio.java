...
public interface ArticuloInventarioServicio {
    ...
    RespuestaServicio<ArticuloInventario> articuloInventarioPorParametros (Optional<String> busqueda, Optional<Long> idBodegaInventario, String skip, String take) throws Exception;
